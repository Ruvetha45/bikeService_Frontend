...
import service from "../images/bike service.jpeg"
...
function Home(props) {
  const[product,setproduct]=useState({
    name:"Service-UP Membership",
    price:10,
    productby:"Service-Up"
});
...
const makePayment = token=>{
  ...
  return(
          ...
          <div className='assurance' style={{display:"flex" , backgroundColor:"#5195e1", width:"80%", marginLeft:"10%",marginTop:"2%",  borderRadius:"10px"}}>
            ...
            <div className='assurance-content' style={{color:"white", width:"50%"}}> 
              ...
              <ul>
                ...
                <li style={{marginTop:"15px"}}>
                  Program Protects users against damage caused during free pickup and delivery of bike.
                </li>
              </ul>
              ...
              <Dialog fullScreen={fullScreen} open={open} onClose={handleClose} aria-labelledby="responsive-dialog-title" fullWidth={true}>
                ...
                <DialogContentText style={{marginTop:"8px", marginBottom:"8px"}}>
                    ...
                    We adhere to our operational excellence commitment towards delivering exceptional customer experience. Everytime you opt for a Free Pickup and Drop with Service-Up, your bike is covered under Service-Up Assurance Program
                  
                </DialogContentText>
                <hr></hr>
                <DialogContentText  style={{marginTop:"8px", marginBottom:"8px"}}>
                  
                    With Service-Up Assurance Program, each customer is protected against any damages caused during the pickuo and delivery of their bike by Service-Up Executive upto a Maximum of Rs.25000
      ...
      <h4>Hand Picked Service for your Valuable Bike</h4>
      </div>
...
<div className='assurance-content' style={{color:"white", width:"50%"}}> 
  ...
  <StripeCheckout 
    ...
    token={makePayment} 
    name="Service-Up Membership Payment"
...
<div className='rectangle2'>  </div>
    ...
    contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }} iconStyle={{ background: '#5195e1', color: '#fff' }}>
            <h2 style={{color:"white"}}>Select the Perfect Bike Service</h2>
    ...
    contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }} iconStyle={{ background: '#5195e1', color: '#fff' }}>
          ...
          <VerticalTimelineElement className="vertical-timeline-element--work"  contentStyle={{ background: '#5195e1', color: '#fff' }}
    contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }} iconStyle={{ background: '#5195e1', color: '#fff' }}>
            <h2 style={{color:"white"}}>Track Your Bike Service Real-Time</h2>
    ...
    contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }} iconStyle={{ background: '#5195e1', color: '#fff' }}>
      ...
      <div style={{marginLeft:"10%",display:"grid", gridTemplateColumns: "45% 45%", marginTop:"5%" , marginBottom:"5%"}}>
        ...
        <div style={{display:"flex", justifyContent:"space-evenly", marginLeft:"10%"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",  justifyContent:"center", alignItems:"center"}}>
            ...
            <h3 style={{fontWeight:"lighter"}}>Save Upto 40% on your Bike Service</h3>
          </div>
        </div>
        <div style={{display:"flex", justifyContent:"space-evenly"}}>
          <div style={{display:"flex", justifyContent:"center", alignItems:"center"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",  justifyContent:"center", alignItems:"center",marginTop:"5%"}}>
            ...
            <h3 style={{fontWeight:"lighter"}}>1/1000Kms unconditional warranty on bike service</h3>
          </div>
        </div>
      ...
      <div className='rectangle2'>  </div>
      <div style={{marginLeft:"10%"}}>
        <h1>Common Bike Service Questions in Madurai </h1>
      </div>
      <div style={{marginLeft:"10%", marginRight:"10%", marginTop:"2%"}}>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography style={{fontWeight:"bold"}}>What if i have any issues with my bike service with Service-Up</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
         Worry not! At Service-UP, we provide a network warranty of 1month or 1000kms on every type of bike service you book or purchase
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
          <Typography style={{fontWeight:"bold"}}>Where Can I Book My Bike Service With Service-Up In Chennai</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
          <Typography style={{fontWeight:"bold"}}>Can I choose a workshop in Chennai of my choice for my bike service</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
         Every bike is assigned a workshop based on various factors like serviceability,spare parts availability,location and then some. Rest assured, Your bike will get the best service in Chennai
          </Typography>
        </AccordionDetails>
      </Accordion>
    ...
    <Footer style={{position:'relative'}} >
            <Footer.Wrapper>
                ...
                <Footer.Column>
                    ...
                    <Footer.Link href="#">Bike Detailing</Footer.Link>
                </Footer.Column>
                <Footer.Column>
