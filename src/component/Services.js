  ...
  <div>
    <div className='home-image3'>
      ...
      <div style={{marginLeft:"10%"}}>
        <h1>Service-Up Service Packages</h1>
      </div>
        ...
        <Card  style={{backgroundColor:"whitesmoke",borderRadius:"2%", display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column"}}>
          ...
          <CardContent>
            ...
            <Box component="form" onSubmit={handlesubmit1}>
              <TextField margin="normal" required id="carregyr" label="Bike Register Year" name="carregyr" autoComplete="carregyr" autoFocus sx={{ml:18}} style={{width:"50%"}}/>
              ...
              <TextField margin="normal" required id="carregno" label="Bike Registration Number" name="carregno" autoComplete="carregno" autoFocus sx={{ml:18}} style={{width:"50%"}}/>
